// export const chaptersPerBookMap = {
//   "Genesis": 50,
//   "Exodus": 40,
//   "Leviticus": 27,
//   "Numbers": 36,
...
import { allBookNames } from "./naming"

export const bookChapterVersesMap: {
  [key: typeof allBookNames[number]]: { [key: string]: number }
} = {
  "1 Nephi": {
    "1": 20,
    "2": 24,
  ...
  "Jacob": { "1": 19, "2": 35, "3": 14, "4": 18, "5": 77, "6": 13, "7": 27 },
  "Enos": { "1": 27 },
  "Jarom": { "1": 15 },
  "Omni": { "1": 30 },
